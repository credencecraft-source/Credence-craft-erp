  ...
  return (
    <div className="min-h-screen bg-[#f4f7f4] px-5 py-10 text-zinc-950">
      <div className="mx-auto max-w-4xl rounded-3xl border border-[#dce4dc] bg-white p-6 shadow-[0_14px_40px_rgba(15,23,42,0.04)]">
        ...
        <h1 className="mt-2 text-3xl font-semibold tracking-tight text-[#17372a]">Factory Management</h1>
        <p className="mt-3 text-sm text-zinc-600">Factory planning, production monitoring, and operational control will be added here.</p>
        <div className="mt-6">
