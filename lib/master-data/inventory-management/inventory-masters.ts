...
export const INVENTORY_MASTER_DEFINITIONS = [
  ...
  createMaster("raw-material-category", "Raw Material Category", "Raw material category classification, independent from product category.", [lookup("Raw_Material_Type1", "Raw Material Type", "raw-material-type", { required: true }), text("Raw_Material_Category", "Raw Material Category", { required: true, unique: true }), text("Create_Cost_Center", "Create Cost Center", { type: "checkbox" })], { labelField: "Raw_Material_Category", moduleGroup: "inventory-management", moduleSubGroup: "inward", moduleOrder: 4 }),
  createMaster("raw-material-sub-category", "Raw Material Sub Category", "Raw material sub category classification, independent from product sub category.", [lookup("Raw_Material_Category1", "Raw Material Category", "raw-material-category", { required: true }), text("Raw_Material_Sub_Category", "Raw Material Sub Category", { required: true, unique: true })], { labelField: "Raw_Material_Sub_Category", moduleGroup: "inventory-management", moduleSubGroup: "inward", moduleOrder: 5 }),
];
