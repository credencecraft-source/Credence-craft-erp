...
export default function GateEntryPage() {
  ...
  const input = (key: keyof FormState, label: string, type = "text", required = false) => <Input label={label} required={required} type={type} value={form[key]} onChange={(event) => update(key, event.target.value)} />;
