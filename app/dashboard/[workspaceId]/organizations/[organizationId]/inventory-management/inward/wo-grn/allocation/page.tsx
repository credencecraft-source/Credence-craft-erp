  ...
  return (
    <UiPage as="div">
      <Section className="space-y-6">
        <Link href={basePath} className="text-xs font-semibold text-sky-700">&larr; WO GRN</Link>
        <Card>
          <h1 className="text-2xl font-bold text-slate-900">Allocation</h1>
          <p className="mt-2 text-sm text-slate-600">Work-order allocation records will appear here.</p>
        </Card>
      </Section>
    </UiPage>
  );
