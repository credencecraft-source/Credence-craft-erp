  ...
  const cards = [
    {
      ...
      label: "Inward",
      title: "WO GRN",
      description: "Open the work-order goods receipt workflow.",
      href: `/dashboard/${workspaceId}/organizations/${organizationId}/inventory-management/inward/wo-grn/report`,
      accent: "emerald",
    },
    {
      key: "verification",
      label: "Verification",
      title: "Verification",
      description: "Review and validate incoming work-order batches.",
      href: `/dashboard/${workspaceId}/organizations/${organizationId}/inventory-management/inward/wo-grn/verification`,
      accent: "amber",
    },
    {
      key: "allocation",
      label: "Allocation",
      title: "Allocation",
      description: "Allocate accepted work-order material to downstream needs.",
      href: `/dashboard/${workspaceId}/organizations/${organizationId}/inventory-management/inward/wo-grn/allocation`,
      accent: "sky",
    },
  ];
