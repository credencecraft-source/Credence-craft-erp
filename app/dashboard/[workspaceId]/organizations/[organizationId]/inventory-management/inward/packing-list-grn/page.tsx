...
export default async function PageRoute({ params }: { params: Promise<{ workspaceId: string; organizationId: string }> }) {
  ...
  const cards = [
    {
      key: "packing-list-grn",
      label: "Inward",
      title: "Packing List GRN",
      description: "Open the packing-list goods receipt workflow.",
      href: `/dashboard/${workspaceId}/organizations/${organizationId}/inventory-management/inward/packing-list-grn/report`,
      accent: "emerald",
    },
    {
      key: "verification",
      label: "Verification",
      title: "Verification",
      description: "Review and validate incoming packing-list batches.",
      href: `/dashboard/${workspaceId}/organizations/${organizationId}/inventory-management/inward/packing-list-grn/verification`,
      accent: "amber",
    },
    {
      key: "allocation",
      label: "Allocation",
      title: "Allocation",
      description: "Allocate accepted packing-list material to downstream needs.",
      href: `/dashboard/${workspaceId}/organizations/${organizationId}/inventory-management/inward/packing-list-grn/allocation`,
      accent: "sky",
    },
  ];
