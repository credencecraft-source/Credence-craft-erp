...
export default async function ApprovalFactoryManagementPage({
  ...
  return (
    <MasterModuleShell
      ...
      title="Factory Management approvals"
      description="Approval queue for factory planning, production, and processing changes."
      subItems={[]}
    >
      <div className="space-y-5">
        <div className="rounded-2xl border border-violet-100 bg-violet-50 p-5">
          <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-violet-700">Factory management</p>
