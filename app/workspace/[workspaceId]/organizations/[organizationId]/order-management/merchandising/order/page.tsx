...
const reportFilterFields: Array<{ key: FilterableOrderField; label: string }> = [
...
export default function MerchandisingOrdersPage() {
  ...
  const handleSelectOrder = (orderId: string) => {
    router.push(`/workspace/${workspaceId}/organizations/${organizationId}/order-management/merchandising/order/${orderId}`);
  };
  ...
  const handleNewOrder = () => {
    router.push(`/workspace/${workspaceId}/organizations/${organizationId}/order-management/merchandising/order/new`);
  };
          ...
          <ReportGrid
            ...
            renderCell={(fieldKey, order) => {
              switch (fieldKey) {
                ...
                default: {
                  const value = (order as Record<string, unknown>)[fieldKey];
                  return value == null ? "-" : typeof value === "string" || typeof value === "number" ? value : String(value);
                }
              }
            }}
          />
